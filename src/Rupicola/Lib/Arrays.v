...
Module VectorArrayCompiler.
  Hint Extern 1 => simple eapply (@ByteVectorArray.compile_get); shelve : compiler.
  Hint Extern 1 => simple eapply (@WordVectorArray.compile_get); shelve : compiler.
  Hint Extern 1 => simple eapply (@ByteVectorArray.compile_put); shelve : compiler.
  Hint Extern 1 => simple eapply (@WordVectorArray.compile_put); shelve : compiler.
End VectorArrayCompiler.

Module ListArrayCompiler.
  Hint Extern 1 => simple eapply (@ByteListArray.compile_get); shelve : compiler.
  Hint Extern 1 => simple eapply (@WordListArray.compile_get); shelve : compiler.
  Hint Extern 1 => simple eapply (@ByteListArray.compile_put); shelve : compiler.
  Hint Extern 1 => simple eapply (@WordListArray.compile_put); shelve : compiler.
End ListArrayCompiler.

Module SizedListArrayCompiler.
  Hint Extern 1 => simple eapply (@ByteSizedListArray.compile_get); shelve : compiler.
  Hint Extern 1 => simple eapply (@WordSizedListArray.compile_get); shelve : compiler.
  Hint Extern 1 => simple eapply (@ByteSizedListArray.compile_put); shelve : compiler.
  Hint Extern 1 => simple eapply (@WordSizedListArray.compile_put); shelve : compiler.
